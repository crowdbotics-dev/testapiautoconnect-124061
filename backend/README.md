...
## Project Structure
    ...
    ├── testapiautoconnect_124061  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnect_124061`
...
2. Clone this repo and `cd testapiautoconnect_124061`
